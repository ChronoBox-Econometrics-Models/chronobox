...
description: "Community standards for the ChronoBox project — based on the Contributor Covenant v2.1."
---
...
This Code of Conduct applies within all project spaces — including the GitHub repository, issue tracker, discussion forums, and pull requests — and also applies when an individual is officially representing the project in public spaces.
